...
Public Class JobOrderPayroll
    ...
    Private Sub JobOrderPayroll_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            sql = "SELECT * from user where appointment like '%" & "Job_Order" & "%'   "
            ...
            Do While DR.Read = True
                ...
                adp1.SelectCommand = New MySqlCommand("SELECT (joborderrate)  from admin ", sql_connection1)
                ...
                DataGridView1.Rows.Add(DR("idnum"), DR("lname"), DR("fname"), DR("mname"), DR("appointment"), tbl.Rows(0)("SEC_TO_TIME(SUM(TIME_TO_SEC(alltotal)))").ToString, tbl1.Rows(0)("joborderrate").ToString, tbl.Rows(0)("sum(gp)").ToString, tbl.Rows(0)("sum(madeduct)").ToString, tbl.Rows(0)("sum(debit)").ToString)
        ...
        'Dim max1 As Integer = DataGridView1.Rows.Count - -2
        'DataGridView1.Rows(max1).Cells(6).Value = ":"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        'e.Graphics.DrawString(direct.Text, font1, Brushes.Black, 100, 850)
        ...
        'e.Graphics.DrawString(collecting.Text, font1, Brushes.Black, 100, 950)
            ...
            Do While mRow < .RowCount
                ...
                For Each cell As DataGridViewCell In row.Cells
                    ...
                    Else
                        ...
                        'e.Graphics.DrawString(Me.DataGridView1.Rows(cell.RowIndex).Cells(cell.ColumnIndex).FormattedValue.ToString(), .Font, Brushes.Black, rc, fmt)
